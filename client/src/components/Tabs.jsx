            ...
            <Tab
              ...
              className={({ selected }) =>
                classNames(
                  ...
                  selected
                    ? "text-blue-700 border-b-2 border-blue-600 dark:text-blue-400 dark:border-blue-500" 
                    : "text-gray-800 hover:text-blue-800 dark:text-gray-200 dark:hover:text-blue-400" 
                )
              }
            >
              {tab.icon}
